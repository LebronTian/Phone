...
$('.csp_remarks li').click(function(){
	...
	if ($('.ceditall').hasClass('am-text-danger')) {
		...
		window.location.href='?_a=form&_u=sp.arecordlist&f_uid='+g_f_uid+'&sp_remark=' + r;
	}
});
...
$('.option_key_btn').click(function(){
	...
	//允许关键字为空，表示清空条件
	if(1 || key) {
		window.location.href='?_a=form&_u=sp.arecordlist&f_uid='+g_f_uid+'&key='+key;
	}
});
...
$('#id_download').click(function(){
	window.location.href = '?_a=form&_u=sp.aexcel&_is_ajax=1&uid=' + g_f_uid;
});
