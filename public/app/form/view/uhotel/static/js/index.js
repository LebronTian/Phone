...
function form_make_text(e) {
    ...
    if(e.id==0) html+= '<img src="/app/form/view/uhotel/static/images/name.png"/> ' ;
    else html+= '<img src="/app/form/view/uhotel/static/images/phone.png"/> ' ;

    html+=
        '<input id="'+ e.id+'" required="true" type="text" placeholder="'+e.desc+'"/> ' +
        '</section>';
    /*
     var html = '<p> ';
     if(e.required) {
...
$('#id_commit').click(function(){
	...
	$.post('?_a=form&_u=ajax.addformrecord', post, function(ret){
        ...
        if(ret.errno!=801&&ret.data&&ret.data>0){
