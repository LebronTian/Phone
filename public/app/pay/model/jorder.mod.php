...
class JOrderMod {
	public function __construct($uid) {
        ...
        if(!($this->o = PointorderMod::get_order_by_uid($uid))) {
	...
	*/
	public function GetOrderInfo() {
		...
		return array(
					...
					'total_fee'=> $this->o['paid_fee'],
					'title'    => '微信支付兑换积分',
					'return_url' => '?_a=qrposter&_u=index.index',
	...
	*/
	public function SavePayInfo($params) {
		...
		return Dba::update('point_order',$update,'uid='.$update['uid']);
	}
	...
	*/
	public function PaySucceedCallback($params) {
        ...
        //支付成功 注意不要重复添加事件
        Event::addHandlerOnce('AfterPayOrder', array('PointorderMod', 'onAfterPayOrder'));
		PointorderMod::pay_order($this->o,$params['pay_type'],$params['pay_info']);
		return true;
	}
