if (void 0 == APP_BASE_URL) var APP_BASE_URL = "";
if (void 0 == GAME_LIST_URL) var GAME_LIST_URL = "";
if (void 0 == FOLLOW_URL) var FOLLOW_URL = "";
...
var	APP_DEPLOYMENT = "WEB",
	...
	SHOW_COPYRIGHT = !1,
	IN_WEIXIN = !1;
0 <= document.URL.indexOf("file://") && (IS_ANDROID || IS_IOS) && (APP_DEPLOYMENT = "APP", USE_NATIVE_SOUND = USE_NATIVE_SHARE = !0, APP_BASE_URL = "http://4miao.com/");
...
var mebtnopenurl = "http://mp.weixin.qq.com/your_weixin_url";

/*window.shareData = {
    "imgUrl": "http://4miao.com/icon/qbllk.png",
    "timeLineLink": "http://4miao.com/games/qbllk/",
    "tTitle": "奇葩连连看-4秒商城",
...
function share() {
    ...
    window.location.href = '?_a=reward&_u=index.statistic&r_uid='+g_r_uid+'&score='+scores+'';
}
function showTop(a) {
