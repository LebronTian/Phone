...
<!-- <?php var_dump($reward);?> -->
	...
	<div class="share_play">
		<a href="?_a=reward&_u=index.christmas&r_uid=<?php echo (empty($reward['uid'])?'':$reward['uid'])?>"> 
    ...
    <audio style="display:none;opacity:0" hidden="hidden" id="christmasMusic" loop="loop" preload="metadata" controls src="/app/reward/view/dial/static/images/christmas.mp3">
	</audio>
