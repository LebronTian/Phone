...
// http://127.0.0.1:88/app/shop/static/modules/images/tabbar/#0099CC/default/#0099CC (9).png
// http://127.0.0.1:88/app/shop/static/modules/images/tabbar/FF6666/default/FF6666%20(14).png
	...
	$.post(requestImgUrl, {
		...
		if(ret.data) {
            ...
            newsList.forEach(function(ele) {
				...
				console.log(ele);
                if (!ele.main_img) ele.main_img = "/app/shop/static/modules/images/noImage.png";
            });
...
var app = new Vue({
	...
	data: {
		...
		contactInfo: {
			show: false,
			imgUrl: "",
			defaultImgUrl: "/app/shop/static/modules/images/contact.jpg",
			link: ""
		},
		editedNode: null,
		/*		底部数据new aad*/
