...
<div class="am-cf am-padding">
    <div class="am-fl am-cf" id="edit-id" <?php if(!empty($data)) echo 'data-id="'.$data['uid'].'"'; ?>>
        <strong class="am-text-primary am-text-lg">  <?php echo(!empty($data) ? '编辑' : '添加')?>易联云打印机</strong> /
    </div>
</div>
<div class="am-form am-form-horizontal" data-am-validator>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-4 am-u-end">
            <input type="text" id="id_params_zhongduanhao" minlength="1" <?php if(!empty($data['params']['zhongduanhao'])) echo 'value="'.$data['params']['zhongduanhao'].'"'; ?>>
        </div>
    </div>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-4 am-u-end">
            <input type="text" id="id_params_miyao" minlength="1" <?php if(!empty($data['params']['miyao'])) echo 'value="'.$data['params']['miyao'].'"'; ?>>
        </div>
    </div>
