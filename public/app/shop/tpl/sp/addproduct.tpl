...
<div class="am-form am-form-horizontal" data-am-validator>
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-4 am-u-end">
            <input type="text" id="product_title" placeholder="选填" minlength="1" <?php if(!empty($product)) echo 'value="'.$product['title'].'"'; ?>>
        </div>
    </div>
    <div class="am-g am-margin-top-sm">
        <div class="am-u-sm-2 am-text-right">
        ...
        <div class="am-u-sm-2 am-u-end">
            <input type="text" placeholder="如 店长推荐" id="title_second" placeholder="选填" minlength="1" <?php if(!empty($product['title_second'])) echo 'value="'.$product['title_second'].'"'; ?>>
        </div>
    </div>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-2 am-u-end">
            <input type="text" id="product_code" placeholder="选填" class="js-pattern-number" <?php if(!empty($product)) echo 'value="'.$product['product_code'].'"'; ?>>
            <small>填写数字，可用于商品的搜索</small>
        </div>
    </div>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-2 am-u-end">
            <input type="text" id="biz_uid" placeholder="选填" class="js-pattern-number" <?php if(!empty($product['biz_uid'])) echo 'value="'.$product['biz_uid'].'"'; ?>>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-8 am-u-end">
            <button style="vertical-align: baseline" class="am-btn am-btn-primary choose-cats" data-uid="<?php echo (!empty($product['cat']) ? $product['cat']['uid']:"") ?>"><?php echo (!empty($product['cat']) ? $product['cat']['title']:"选择分类") ?></button>
    ...
    <div class="am-g am-margin-top-sm margin-top">
        ...
        <div class="am-u-sm-8 am-u-end">
            <select class="basic-services am-modal-prompt-input" multiple style="width:80%;margin-top: 10px">
                <?php
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-8 am-u-end" style="width: 120px">
            <input type="number" id="product_sort" placeholder="选填" <?php if(!empty($product)) echo 'value="'.$product['sort'].'"'; ?>>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-2 am-u-end">
            <div style="width: 80%;float:left;">
                <input type="text" id="oriPrice" placeholder="必填，展示在商品列表封面，商品吊牌价、销售指导价" pattern="^[0-9]+(.[0-9]{1,100})?$" minlength="1" <?php if(!empty($product)) echo'value="'.($product['ori_price']/100).'"';?>>
            </div>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-2 am-u-end">
            <div style="width: 80%;float:left;">
                <input type="text" id="proPrice" placeholder="必填，展示在商品列表封面，用户最终的购买价格" pattern="^[0-9]+(.[0-9]{1,100})?$" minlength="1" <?php if(!empty($product)) echo'value="'.($product['price']/100).'"';?>>
            </div>
            <div class="price-yuan">
                元
            </div>
...
<hr>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-2 am-u-end">
            <div style="width: 80%;float:left;">
                <input type="text" id="back_point" placeholder="选填，请输入正整数" pattern="^[0-9]+(.[0-9]{1,100})?$" <?php if(!empty($product)&&(!($product['back_point']=="0"))) echo 'value="'.$product['back_point'].'"' ?> >
            </div>
        </div>
    </div>
    ...
    <div class="am-g am-margin-top-sm select-standard" id="standard1">
        ...
        <div class="am-u-sm-8 am-u-end" style="width: 160px">
            <div style="width: 88px;float:left;">
                <input type="text" id="proQuantity" placeholder="必填" minlength="1" pattern="^[0-9]\d*$" >
            </div>
            <div class="price-yuan">
                件
            </div>
    ...
    <div class="am-g am-margin-top-sm margin-top">
        ...
        <div class="am-u-sm-8 am-u-end">
            ...
            <div class="sel-addr" style="display: none">
                <select class="sel-town">
                    <option>地区</option>
                </select>
            </div>
            <div class="sel-addr" style="width: auto;display: none">
                <input class="sel-street" type="text" placeholder="详细街道(选填)"/>
            </div>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-8 am-u-end">
            <input type="text" id="video_url" placeholder="选填" minlength="1" <?php if(!empty($product['video_url'])) echo 'value="'.$product['video_url'].'"'; ?>>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-8 am-u-end">
            <input type="number" id="id_sell_cnt" placeholder="选填" minlength="1" <?php if(!empty($product['sell_cnt'])) echo 'value="'.$product['sell_cnt'].'"'; ?>>
        </div>
    </div>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-8 am-u-end" style="width: 120px">
            <input type="number" id="buy_limit" placeholder="选填" <?php if(!empty($product)) echo 'value="'.$product['buy_limit'].'"'; ?>>
            <small style="white-space: nowrap">限购份数，0表示不限</small>
        </div>
    </div>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-8 am-u-end">
            <input type="text" id="product_uids" placeholder="选填" minlength="1" <?php if(!empty($product['product_uids'])) echo 'value="'.$product['product_uids'].'"'; ?>>
...
//    var catsAll = [];
    ...
    $extra_js = array(
        ...
        $static_path.'/js/addproduct.js?1',
