...
<div class="am-g am-padding">
    ...
    <a  href="?_a=shop&_u=sp.addbizcat" type="button" class="am-btn am-btn-success"><span class="am-icon-plus"></span> 添加分类</a>
	</div>
...
<?php
	if(!$cats) {
		...
		foreach($cats as $c) {
			...
			$html .= '<a href="?_a=shop&_u=sp.addbizcat&uid='.$c['uid']
