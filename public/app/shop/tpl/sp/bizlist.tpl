<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">商家入驻列表</strong> /
<small>共计 <?php echo $data['count'];?> 家</small></div>
</div>

<div class="am-g am-padding">
    <div class="am-fl am-cf">
        <a  href="?_a=shop&_u=sp.addbiz" type="button" class="am-btn am-btn-success"><span class="am-icon-plus"></span> 添加商家</a>
        <a target="_self"  href="?_a=shop&_u=admin" type="button" class="am-btn am-btn-success"><span class="am-icon-plus"></span> 商家入口</a>
    </div>
...
<div class="am-u-sm-12" style="min-height: 300px">
    <table class="am-table am-table-striped am-table-hover table-main">
        ...
        <tr>
            ...
            <th class="table-parent">红包</th>
            <th class="table-parent">类型</th>
            <th>联系人</th>
            <th>是否加V</th>
            <th>是否推荐</th>
            <th>审核状态</th>
        ...
        <tr '.($p['status']==2 ? "class='am-danger'":"").' data-id="'.$p['uid'].'">
            ...
            <td><a href="?_a=shop&_u=sp.bizcoupon&biz_uid='.$p['uid'].'">'.$p['coupon_number'].'(点击查看)</a></td>
            <td>'.($p['type']).'</td>
            <td>'.$p['contact'].'<br>'.$p['phone'].'</td>
            <td><a class="paddv am-btn am-btn-xs '.($p["hadv"]==1 ? 'am-btn-warning">加V' : 'am-btn-default">不加V').'</a></td>
            <td><a class="paddrecommend am-btn am-btn-xs '.($p["hadrecommend"]==1 ? 'am-btn-secondary">推荐' : 'am-btn-default">不推荐').'</a></td>
            ...
            <td>
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="?_a=shop&_u=sp.addbiz&uid='.$p['uid'].'" class="am-btn am-btn-default am-btn-xs am-text-primary">
