...
<div class="am-g am-padding">
	...
	<div class="am-u-md-4">
		<a  href="?_a=shop&_u=sp.distribution_user_set" type="button" class="am-btn am-btn-success"><span class="am-icon-plus"></span> 添加设置分销成员</a>
	</div>
	...
	<table class="am-table am-table-striped am-table-hover table-main">
		...
		else
		{
			...
			foreach ($dtb_user_list['list'] as $m)
			{
				...
				{
					$html .= '<td><a  class="am-btn am-btn-warning "  href="?_a=shop&_u=sp.distribution_user_list&su_uid=' . $m['parent_user']['uid'] . '">' .
				...
				if(!empty($m['L1_cnt']))
				{
					$html .= '<td><a  class="am-btn am-btn-warning "  href="?_a=shop&_u=sp.distribution_user_list&parent_su_uid=' . $m['su_uid'] . '">' . (empty($m['L1_cnt']) ? '0' : $m['L1_cnt']) . '</td>';
				...
				//            $html .= '<button class="am-btn am-btn-secondary am-btn-xs message-more" onclick="window.location.href=\'?_a=shop&_u=sp.edit_message&uid='.$m['su_uid'].'\'">查看详情</button>';
