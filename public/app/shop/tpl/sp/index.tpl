...
<div class="am-padding"   style="background-color: #f8f5f0">
			...
			<div>
				...
				<div id="button-link">
					<ul class="am-avg-sm-2 am-thumbnails">
						...
						<li><a target="_self" href="?_a=shop&_u=sp.orderlist"><span style="background-color:#88d8f9;" class="am-icon-btn am-icon-files-o"></span><div class="li-title" >订单列表</div></a></li>
						<li><a target="_self" href="?_a=su&_u=sp.fanslist"><span style="background-color:#88d8f9;" class="am-icon-btn am-icon-users"></span><div class="li-title">用户管理</div></a></li>
						<li><a target="_self" href="?_a=vipcard&_u=sp.vip_card_list"><span style="background-color:#88d8f9;" class="am-icon-btn am-icon-list-alt"></span><div class="li-title">会员管理</div></a></li>
						<li><a target="_self" href="?_a=shop&_u=sp.order_record"><span style="background-color:#88d8f9;" class="am-icon-btn am-icon-line-chart"></span><div class="li-title">货单统计</div></a></li>
						<li><a target="_self" href="?_a=shop&_u=sp.shopcoupon"><span style="background-color:#88d8f9;" class="am-icon-btn am-icon-money"></span><div class="li-title">优惠券管理</div></a></li>
						<li><a target="_self" href="?_a=shop&_u=sp.distribution_user_list"><span style="background-color:#88d8f9;" class="am-icon-btn am-icon-gear"></span><div class="li-title" >分销设置</div></a></li>
					</ul>
				</div>
			</div>
...
//			window.location.href='?_a=sp&_u=index.links&key='+key;
	...
	if((wx_type & 8) == 8){
		...
		$('.wxqrcode').append('<img style="width:200px;height:200px;" src="?_uct_token='+uct_token+'&_u=xiaochengxu.qrcode&path='+encodeUrl+'">');
	}
