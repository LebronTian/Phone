<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">购前须知编辑</strong> / </div>
</div>

<div class="am-g am-padding">
    <div class="am-fl am-cf">
        <a  href="?_a=shop&_u=sp.addknow_before" type="button" class="am-btn am-btn-success"><span class="am-icon-plus"></span> 添加购前须知</a>
    </div>
</div>
           ...
           // $html .= '<td>'.htmlspecialchars(mb_substr($p['content'], 0, 20, 'utf-8')).'...</td>';
            ...
            <td><div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="?_a=shop&_u=sp.addknow_before&uid='.$p['uid'].'" target="_self" class="am-btn am-btn-default am-btn-xs am-text-primary">
...
<?php
	$extra_js = $static_path.'/js/know_beforelist.js';
?>
