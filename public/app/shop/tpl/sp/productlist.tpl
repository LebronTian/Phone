...
<div class="am-g am-padding">
	...
	<div class="am-u-md-3 am-end am-fr">
		<div class="am-form-group am-margin-left am-fl">
			<a data-am-popover="{content: '导出库存表到excel格式文件', trigger: 'hover focus'}"
            ...
            <td>
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="?_a=shop&_u=sp.addproduct&uid='.$p['uid'].'&page='.$option['page'].'" class="am-btn am-btn-default am-btn-xs am-text-primary">
