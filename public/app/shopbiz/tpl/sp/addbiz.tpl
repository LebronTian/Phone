...
<div class="am-cf am-padding">
    <div class="am-fl am-cf" id="edit-id" <?php if(!empty($biz)) echo 'data-id="'.$biz['uid'].'"'; ?>>
        <strong class="am-text-primary am-text-lg">  <?php echo(!empty($biz) ? '编辑' : '添加')?> 入驻商</strong> /
    </div>
</div>
...
<?php if(!empty($biz['uid'])) { ?>
			<a target="_self" href="?_a=shopbiz&_u=sp.bizdetail&uid=<?php echo $biz['uid'];?>" type="button" class="am-btn am-btn-default"><span class="am-icon-line-chart"></span> 查看详情</a>
<?php } ?>
        </div>
    </div>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-2">
            <input type="text" id="biz_account" minlength="1" placeholder="请输入修改账号" <?php if(isset($biz['account'])) echo 'value="'.$biz['account'].'"'; ?>>
        </div>
        <div class="am-u-sm-4 am-u-end">
...
<hr/>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-8 am-u-end">
            ...
            <small><a href="?_a=shopbiz&_u=sp.bizcatlist">分类管理</a></small>
        </div>
    </div>
