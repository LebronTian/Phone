...
<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">特定商品分佣比例</strong> / <small></small></div>
</div>
...
<?php
if(!empty($dtb['p_uid'])) {
	$p = ProductMod::get_shop_product_by_uid($dtb['p_uid']);
	echo $p['title'].' <img style="width:64px;" src="'.$p['main_img'].
	'"><input  id="p_uid" style="display:none;" value="'.$p['uid'].'">';
}else {
echo '<input type="text" id="p_uid">';
}
?>
