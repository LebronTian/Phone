...
<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">特定商品分销比例</strong> / </div>
</div>

<div class="am-g am-padding">
    <div class="am-fl am-cf">
        <a  href="?_a=shopdist&_u=sp.adddistribution_product" type="button" class="am-btn am-btn-success"><span class="am-icon-plus"></span> 添加分销商品</a>
    </div>
</div>
            ...
            $html.='<td>
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="?_a=shopdist&_u=sp.adddistribution_product&uid='.$p['uid'].'" class="am-btn am-btn-default am-btn-xs am-text-primary">
