...
//					'<td class="table-check"><input type="checkbox" class="ccheck"></td>' .
					'<td>'.$m['uid']. '</td><td><a href="?_a=shopdist&_u=sp.orderlist&su_uid='.$m['su_uid'].'">' .
					$m['user']['name'] . '</a></td><td>' .

					'<a href="?_a=shopdist&_u=sp.orderlist&key='.$m['order_uid'].'">' .$m['order_uid'].'</a></td><td>' .
