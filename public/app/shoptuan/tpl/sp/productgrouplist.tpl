<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">团购商品列表</strong> / <small>共<?php echo $products['count'];?> 件商品</small></div>
</div>

<div class="am-g am-padding">
    <div class="am-fl am-cf">
        <a  href="?_a=shoptuan&_u=sp.addproduct" type="button" class="am-btn am-btn-success"><span class="am-icon-plus"></span> 添加团购商品</a>
    <button style="margin-left: 1em;display:none" class="am-btn am-btn-primary choose-cats">
        <?php
            ...
            <td>
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="?_a=shoptuan&_u=sp.addproduct&uid='.$p['uid'].'" class="am-btn am-btn-default am-btn-xs am-text-primary">
    ...
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <div style="overflow: scroll;max-height: 40em">
                <a href="?_a=shop&_u=sp.productgrouplist"><button style="margin: 0.5em 0" class="am-btn am-btn-success">全部商品</button><br></a>
...
$extra_js = array(
    ...
    $static_path.'/js/productgrouplist.js',
