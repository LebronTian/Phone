...
$k = 'cfg_site_eyeis_setcolor_'.AccountMod::get_current_service_provider('uid');
...
<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"> <span style="color:black;">1号模板</span> 颜色设置</strong> / <small></small></div>
</div>
