...
<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"> <span style="color:black;">3号模板</span> 颜色设置</strong> / <small></small></div>
</div>
...
<div class="am-form">
        ...
        <div class="am-u-sm-10 am-u-sm">
          <button class="am-btn am-btn-lg am-btn-primary show_tpl"  data-src="<?php echo DomainMod::get_app_url('site', 0, '__tpl=wapsite');?>
            ">预览
          </button>
        </div>
