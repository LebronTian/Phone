$('.save').click(function(){
	...
	$.post('?_a=sp&_u=api.addattach', data, function(ret){
		ret = $.parseJSON(ret);
		if (ret.errno==0) 
		{
			...
			setTimeout(function(){
               // history.back()
				window.location.href='?_a=sp&_u=index.attachlist&pos='+data.pos;
			},1000);
		}
		else
