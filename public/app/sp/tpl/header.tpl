...
<style type="text/css">
    ...
    .select_menu{ display: none; position: absolute; left: 20px; top: 12px; width: 142px; padding: 5px 5px 10px; text-align: left;}
    .select_menu li{ width: 100%; height: 28px; line-height: 28px;}
    .select_menu li a{ font-size: 16px; padding: 0;}
</style>
</head>
<div id="headBox">
    <a href="?_a=web" class="logo">
    	<!--<img style="display:inline-block;height:54px;" src="/app/web/static/images/blue/logo.png" alt="logo">-->
    ...
    <ul class="headNav">
        ...
        <li class="partnership_link"><a href="?_easy=web.index.partnership&partnership=1">合作加盟</a></li>
        <li style="position:relative;" class="select_li">
            <a href="javascript:;" target="_black">关于我们<span>+</span></a>
            <ul class="select_menu">
        ...
        <li><a href="?_a=sp&_u=index.login" style="padding-right:0;">登录</a> 
        	<!--<a href="?_a=sp&_u=index.register" style="padding-left:5px;">注册</a>-->
        </li>
