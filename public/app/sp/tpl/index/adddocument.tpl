...
<div class="am-cf am-padding">
    <div class="am-fl am-cf">
        <strong class="am-text-primary am-text-lg">编辑文案</strong>
    </div>
</div>
<div class="am-form am-form-horizontal" data-am-validator>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-8 am-u-end">
            <input type="text" id="video_link"  value="<?php if(!empty($document['video_link'])) echo $document['video_link'] ?>" minlength="1" >
        </div>
    </div>
...
<?php
    ...
    $extra_js = array(
        ...
        $static_path.'/js/updatedocuments.js'
        );
?>
