            ...
            <div class="s_main_bd">
                ...
                <div class="s_edit_area" style="position:relative">
                    ...
                    <div class="s_appmsg_edit_item s_fm_h">
                        <label for="" class="s_frm_label">封面<span class="sl_enter">（大图片建议尺寸：900像素 * 500像素）</span></label>
                    ...
                    <!-- 单图文btn -->
                    <button class="btn imgBoxBtn" id="btn"  data-am-popover="{content: '请选择图片', trigger: 'hover'}">从图片库选择</button>
                    ...
                    <div class="s_appmsg_edit_item zz_h">
                        <label for="" class="s_frm_label">原文链接<span class="sl_enter">（选填）</span></label>
			                      <span class="s_frm_input_box">
			                          <input type="text" class="s_frm_input s_frm_input_link" data-am-popover="{content: '请输入带有http;//的正确链接', trigger: 'hover'}">
			                      </span>
                    </div>
                </div>
            </div>
...
<?php
	$extra_js = array(
        '/static/js/wx_edit_yhc.js?v=0.2',
        '/app/sp/static/js/jquery.qqFace.js',
        '/app/sp/static/js/data.js',
        '/app/sp/static/js/medialist.js?v=0.2',
