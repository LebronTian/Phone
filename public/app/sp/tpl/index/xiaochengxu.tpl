...
当前小程序 <?php echo '<a class="am-text-lg" href="?_a=sp&_u=index.addpublic&uid='.$public['uid'].'">'.$public['public_name'].'</a>';?>
</div>
...
<div class="am-g am-padding">
	<div class="am-u-sm-2">
		<strong>第一步：上传代码</strong>
	</div>
	
	<div class="am-u-sm-2">
	<select id="id_code" class="am-input">
	<?php
...
if(!empty($_GET['_d']) || empty($audit['upload_time'])) {
?>
	<a class="am-btn am-btn-danger" id="id_upload"><span class="am-icon-upload"></span> 一键上传模板代码</a>
<?php } else { ?>
	<span class="am-icon-check am-text-success"></span> <?php echo date('Y-m-d H:i:s', $audit['upload_time']);?> 已上传
<?php } ?>
	</div>
</div>
...
?>;
	...
	<div class="am-u-sm-4">
		<input id="id_title" type="text" class="am-input am-input-lg" placeholder="请填写页面标题" value="<?php echo $public['public_name']?>">
	</div>
	<div class="am-u-sm-4 am-u-end">
...
<div class="am-g am-form" style="margin-top:5px;margin-left:15px;">
	...
	<div class="am-u-sm-4 am-u-end">
		<input id="id_tag" type="text" class="am-input am-input-lg" placeholder="请填写小程序标签，可用空格分开最多5个">
	</div>
</div>

<div class="am-g am-form" style="margin-top:15px;">
	<div class="am-u-sm-2">
		&nbsp;
	</div>
	<div class="am-u-sm-1" style="margin-left:15px;">
