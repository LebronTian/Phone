...
<div class="am-g am-padding">
    ...
    <a  href="?_a=<?php echo $app;?>&_u=sp.addslide" type="button" class="am-btn am-btn-success"><span class="am-icon-plus"></span> 添加幻灯片</a>
	</div>
...
<?php
	if(!$slides) {
		...
		foreach($slides as $c) {
			...
			$html .= '<a href="?_a='.$app.'&_u=sp.addslide&uid='.$c['uid']
