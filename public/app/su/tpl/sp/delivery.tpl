...
<div class="am-cf am-padding">
  <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">配送员订单</strong></div>
</div>

<div class="am-g am-padding">
	<div class="am-u-md-6">
	<div class="am-fl am-cf">
    <a  href="?_a=su&_u=sp.adddelivery" type="button" class="am-btn am-btn-success"><span class="am-icon-plus"></span> 添加配送员订单</a>
	</div>
	</div>
...
<?php
	if(!$list) {
		...
		foreach($list as $c) {
			...
			$html .='<td><a href="?_a=su&_u=sp.fansdetail&uid='.$c['su_uid'].'">'
		.$c['realname'].'</a></td>';
			...
			$html .= '<a href="?_a=su&_u=sp.adddelivery&uid='.$c['uid']
