...
<div class="am-cf am-padding">
  <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">微信群</strong>/
 <small>仅限小程序商户使用</small></div>
</div>
...
if(!empty($_GET['_d'])) {
echo '
    <a  href="?_a=su&_u=sp.addwechatgroup" type="button" class="am-btn am-btn-success"><span class="am-icon-plus"></span> 添加微信群</a>';
}
?>
	</div>
	</div>
...
<?php
	$extra_js = $static_path.'/js/wechatgroups.js';
?>
