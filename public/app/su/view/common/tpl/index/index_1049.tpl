			...
			<div class="wx_body weui_tab_bd">
				<div class="wap_shop_module_list">
							...
							<div class="weui_cells" style="margin-bottom:60px;">
								...
								<div class="weui-cell">
									<div class="weui-cell__hd"><label class="weui-label">我的积分:</label></div>
									<div class="weui-cell__bd">
<a href="?_a=qrposter">
<?php
$pt = SuPointMod::get_user_points_by_su_uid();
echo $pt['point_remain'];
?>
</a>
									</div>
								</div>
								<div class="weui-cell">
									<div class="weui-cell__hd"><label class="weui-label">我的朋友:</label></div>
									<div class="weui-cell__bd">
<a href="?_easy=su.common.index.team">
点击查看
</a>
									</div>
								</div>
...
<div class="weui-footer" style="position:fixed;z-index:9;margin:0 auto;bottom:5px;width:100%;text-align:center;">
	<a href="http://weixin.uctphp.com">© 技术支持-深圳市快马加鞭科技有限公司</a>
</div>
