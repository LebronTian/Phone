<div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">子帐号列表</strong> / </div>
</div>
<?php
#var_export($option);
#var_export($cats);
...
<div class="am-u-sm-12">
    <p class="public-title">
        <span style="color: #5eb95e" class="title-number"><?php echo $cnt ?></span>（已有的子账号）
        /
        <span>&nbsp;<?php echo $max_subsp_cnt ?></span>（子账号配额）
    </p>
    <a href="?_a=subsp&_u=sp.addsubsp"><button class="am-btn am-btn-secondary" <?php if($cnt>=$max_subsp_cnt) echo 'disabled'; ?>>
		添加子账号</button></a>
    <a href="?_a=sp&_u=index.servicedetail&uid=6"><button class="am-btn am-btn-success">购买子账号配额</button></a>
        ...
        if(!$data) {
            ...
            foreach($data as $l) {
              ...
              <td>
                ...
                $html .= '<a href="?_a=subsp&_u=sp.addsubsp&uid='.$l['uid'].'" class="am-btn am-btn-default am-btn-xs"><span class="am-icon-trash-o"></span> 编辑</a>';
