...
<div class="am-padding" >
	<div class="am-u-md-1">
		<a class="am-btn am-btn-success am-lg" href="?_a=templatemsg&_u=sp.templateset&even=<?php echo $_REQUEST['even']; ?>">
	...
	<table class="am-table am-table-striped am-table-hover table-main">
		...
		else
		{
			...
			foreach ($template_user_set_list['list'] as $t)
			{
				...
				$html .= '<td>' . (empty($t['su_uid'])?'对应用户':$t['user']['name']) . '</td>';

				$html .= '<td><div class="am-btn-toolbar"><div class="am-btn-group am-btn-group-xs">' .
					'<a href="?_a=templatemsg&_u=sp.templateset&uid=' . $t['uid'] . '&public_uid=' . $t['public']['uid'] . '&even=' .$_REQUEST['even'].
