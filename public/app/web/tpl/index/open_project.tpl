...
<div class="content_item">
    <div class="post">
        <h1 style="background-color:#EEE; border-left: 5px solid #4168E2; margin-bottom: 5px;">&nbsp;开源项目
        </h1>
        <div class="post_cont">
            <p>
               <a href="http://git.oschina.net/uctoo/uctoo" target="_blank">git.oschina.net/uctoo/uctoo</a>
            </p>
            <p style="padding:0;font-size:24px;padding-left:20px;">扫一扫捐赠</p>
            <p><img src="/app/web/static/images/jz.png" alt="扫一扫捐赠"></p>
        </div>
    </div>
</div>
