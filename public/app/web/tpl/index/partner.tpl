...
<div class="content_item">
    <div class="post">
        <h1 style="background-color:#EEE; border-left: 5px solid #4168E2; margin-bottom: 5px;">&nbsp;合作伙伴
        </h1>
        <div class="post_cont">
            <p>
               opensns <a href="http://www.opensns.cn" target="_blank">http://www.opensns.cn</a>
            </p>
            <p>
               Pingxx <a href="http://pingxx.com" target="_blank">https://pingxx.com</a>
            </p>
            <p>
               大豆网 <a href="http://www.kaihuia.com" target="_blank">www.kaihuia.com</a>
            </p>
            <p>
               创新谷 <a href="http://www.innovalley.com.cn" target="_blank">www.innovalley.com.cn</a>
            </p>
        </div>
    </div>
</div>
