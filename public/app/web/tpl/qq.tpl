    <div class="contact_qq_box">
      <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2529270756&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:2529270756:53" alt="联系我们" title="联系我们"/></a>
    ...
    <a title="查看在线客服" href="javascript:void(0);"><img src="/app/sp/static/images/open_qq.png"></a>
      ...
      <button onclick="window.location.href='?_a=sp&_u=index.register'" class="free_btn">
        <!-- <img border="0" src="/app/web/static/images/free.png" alt="免费试用" title="免费试用"> -->
        免费试用
      </button>
    </div>
