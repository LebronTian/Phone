...
foreach($cats as $c) {
$html .= '<a href="?_a=shop&_u=sp.orderlist8&status='.$c['uid'].'"><li';
...
$html .= '</div>
							...
							<div class="zhicwl-bdan zhicwl-bdan2">
								<dl class="display-box box-align-center" data-id="'.$o['uid'].'">
									...
									<dd class="zhicwl-bdan-datit display-box box-align-center box-flex">';
foreach($o['products'] as $p) {
	$html .= '
			<div class="zhicwl-bdan-img"><img style="width:64px;" src="'.$p['main_img'].'"></div>
			<div class="color1 am-text-truncate width150">'.$p['title'].'</div>
									';
}
