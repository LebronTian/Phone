<?php
if(empty($shop['tpl'])) {
Dba::write('update shop set tpl = "xiaochengxu" where uid = '.$shop['uid']);
}
?>
...
<div class="am-form">
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-8 am-u-end">
            <input type="text" class="input200" id="id_title" value="<?php if(!empty($shop['title'])) echo $shop['title'] ?>">
        </div>
    </div>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-8 am-u-end">
            <input class="input200" type="text" id="id_notice" value="<?php if(!empty($shop['notice'])) echo $shop['notice'] ?>">
        </div>
    </div>
    <div class="am-g am-margin-top-sm">
        <div class="am-u-sm-2 am-text-right">
...
<hr>
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-2 am-u-end" style="display: flex;">
            <input class="input200" type="number" id="discount"  value="<?php echo(!empty($point['discount']))? $point['discount'] : '' ; ?>" >
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-2 am-u-end" style="display: flex;">
            <input class="input200" type="number" id="point_limit"  value="<?php echo(!empty($point['point_limit']))? $point['point_limit'] : '' ; ?>" >
    ...
    <div class="am-g am-margin-top-sm">
        ...
        <div class="am-u-sm-2 am-u-end" style="display: flex;">
            <input class="input200" type="number" id="discount_limit"  value="<?php echo(!empty($point['discount_limit']))? $point['discount_limit']/100 : '' ; ?>" >
