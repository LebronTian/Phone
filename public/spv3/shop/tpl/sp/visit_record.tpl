...
<div class="am-padding  am-cf">
	...
	<div class="am-form-group pd0 am-fl am-margin-right">
	...
	<form class="am-form-inline  am-fl" role="form">
            <span>开始时间：</span>
        	<div class="am-form-group">
        		<button type="button" class="am-btn time-btn" id="my-start"><span id="my-startDate"><?php echo date('Y-m-d', (empty($option['start_time']) ? time() : $option['start_time'])) ?></span></button>
        	</div>
...
<!-- <div class="am-padding  am-cf">
	...
	<div class="am-u-sm-2 am-margin-left am-u-end">
...
<div class="am-padding am-margin-top">
	<div class="am-g">
		...
		<div id="id_echart" class="am-padding am-margin admin-content-list" style="height: 500px;width: 90%">
			图表加载中...
		</div>


		<div id="id_echart2" class="am-padding am-margin admin-content-list" style="height: 600px;width: 90%">
			图表加载中...
		</div>
...
$extra_js = array(
	...
	'/spv3/shop/static/js/visit_record.js',
);
