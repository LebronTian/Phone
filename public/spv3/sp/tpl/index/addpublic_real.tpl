...
<div class="addpublic-content" <?php if(!empty($public['uid'])) echo 'style="display:none"' ?>>
    <p class="addpublic-title" data-am-scrollspy="{animation:'scale-up', repeat: false}">请选择绑定小程序方式</p>
<!--    <p class="addpublic-slide" data-am-scrollspy="{animation:'scale-up', repeat: false}">请选择绑定公众号方式</p>-->
    <div class="btn-box">
        <ul>
            <li>
                <button class="am-btn am-btn-secondary add-btn head-add2 fake-public2 ">稍后添加</button>
<!--                <img class="recommend-icon" src="/static/images/recommend.png"/>-->
            </li>
            <li>
                <button class="am-btn am-btn-success add-btn auto-add component_btn">扫码授权</button>
                <img class="recommend-icon" src="/static/images/recommend.png" data-am-scrollspy="{animation:'scale-down', repeat: false,delay:500}" />
            </li>
        </ul>
        <div style="text-align: left;margin-top: 100px; display:none;">
...
<div class="am-modal am-modal-confirm" tabindex="-1" id="fake-confirm" style="top:250px;">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">您可以稍后绑定再小程序</div>
        <div class="am-modal-bd">
            <span class="am-btn-danger2">不设置将无法正常使用小程序相关功能<br/>
            可用作基础功能及平台体验使用。
        </div>
...
$extra_js = array(
    ...
    '/spv3/sp/static/js/addpublic_real.js',
);
?>
