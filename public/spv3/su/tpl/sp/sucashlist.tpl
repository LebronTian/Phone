<div class="am-cf am-padding">
  <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">储值记录</strong> / <small>总计 <?php echo $data['count'];?> 条记录</small> <a href="?_a=su&_u=sp.cashset">储值规则</a></div>
</div>
...
<table class="am-table am-table-hover table-main pro-table-self cats-table-self">
	<thead>
		<tr>
			<!--<th class="table-check"><input type="checkbox"></th>--><th class="table-title">用户名</th>
