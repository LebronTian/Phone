...
document.writeln("                  ");
document.writeln("                  <div class=\"upload_box\" style=\"clear:both;margin-bottom:10px;width:100px;position:absolute;right:52px;top:52px;\">");
document.writeln("                    ");
...
document.writeln("<button type='button' class=\"am-btn am-btn-primary\" id=\"file_upload_tk\">上传图片</button>");
document.writeln("");
document.writeln("                  </div>");

document.writeln("<button onclick='window.open(\"?_a=material&_u=sp&initType=2\")' class='weixinImage-btn am-btn am-btn-primary' style='position: absolute;top: 43px;right: 47px;display: none'>上传图片</button>");

document.writeln("                  <div style=\"height:40px;\"><button class='systemBtn am-btn am-round am-btn-success'>大师推荐图片</button></div>");
...
document.writeln("                  </ul>");
document.writeln("");
document.writeln("                  <ul id=\"PageBar\">");
document.writeln("                  </ul>");
document.writeln("");
...
$(function() {
    ...
    if(1){
        /*获取类别*/
        $.getJSON("?_a=upload&_u=index.get_file_group&public_image=1",function (ret) {
            /*初始化盒子*/
            var html =
